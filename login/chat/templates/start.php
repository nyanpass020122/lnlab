...
<head>
	...
	<link rel="contents" href="/login/" title="管理パネルへ" />
...
<div id="form">
	...
	<form action="<?php o($_SERVER['PHP_SELF'])?>" method="post">
		<div>
			<label>名前：<?php echo $username; ?><input type="hidden" name="name" value="<?php echo $username;?>" /></label>
			<label>文字色
				<select name="color">
