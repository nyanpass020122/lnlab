<?php
    ...
    class RequestDispatcher {
        ...
        public function extractArchive($context) {
            ...
            $extractor = ExtractorFactory::getDefaultExtractor($archivePath, $extractDirectory);

            try {
                $finalExtract = $extractor->extractAndUpload($this->connection, $context['fileIndexOffset'],
